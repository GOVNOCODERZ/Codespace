...
#include <fstream>
#include <vector>
#include <stack> // Для итеративного обхода (если нужно)
#include <string>
...
protected:
    ...
    // Сбор всех значений узлов в вектор (для варианта 5)
    ...
    // Сбор узлов, находящихся на заданном уровне (для варианта 5)
    ...
    // Сохранение дерева в файл (pre-order)
...
public:
    ...
    void printTree() const { print(root, 0, cout); }
