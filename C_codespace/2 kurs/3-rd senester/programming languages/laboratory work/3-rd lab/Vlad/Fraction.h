...
public:
    ...
    /**
     * @brief Второй конструктор из двух целых чисел (с фиктивным параметром).
     * Предназначен для внутреннего использования или в специфичных случаях.
     * Выполняет нормализацию.
     * 
     * @param n Числитель.
     * @param d Знаменатель.
     * @param dummy Фиктивный параметр для отличия от обычного конструктора.
     */
